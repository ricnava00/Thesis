...
class ProductsMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-catalog-api/products")
...
class CategoriesMessageType(MessageType):  # Note: the response code for this message is always 500 for a bug in the server code
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-catalog-api/categories")
...
class BuildProductMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-catalog-builder/product")
...
class ProductImageMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-catalog-builder/image")
...
class ProductPurchaseMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-purchase")
...
class PhotographerRegisterMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-photos-register")
...
class PhotoRequestMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-photos/request")
...
class PhotoAssignmentMessageType(MessageType):
    ...
    @classmethod
    def match_request(cls, method: str, uri: str, headers: dict[str, str], body: str) -> bool:
        return method_and_uri_match(method, uri, "POST", "/function/product-photos/photos")
