...
for n, results in enumerate(all_results):
    ...
    if not args.stats_only:
        ...
        if args.filter_percentile != 100:
            ...
            plt.plot(important, label=filename, color=colors[n+args.color_offset], marker=".", markeredgecolor='none', markersize=1, linestyle="-", linewidth=0.1)
